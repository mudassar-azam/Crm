                                ...
                                <div class="pair2">
                                    <div class="pair2-card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-name">
                                                <h4 id="client-paid" style="cursor:pointer">Client received invoices
                                                </h4>
                                                <h6>CIG paid Invoices</h6>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pair2-card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-name">
                                                <h4 id="client-unpaid" style="cursor:pointer">Client receivable Invoices
                                                </h4>
                                                <h6>CIG unpaid Invoices</h6>
                                            </div>
                                        </div>
    ...
    <div class="section1">
        <div class="detail-cards">
            ...
            <div class="pair2">
                ...
                <div class="detail-card1" style="height: 22em;">
                    <h6>Engineer Cost In Euros</h6>
                    <div class="card-detail">
                        <h4>{{$techsumInEuros}}€</h4>
                    </div>
                    <div style="height: 80%; display: flex; align-items: center;">
                        <canvas class="revenue5" style="height: 220px !important;"></canvas>
                    </div>
                </div>
            </div>
        </div>
        <div class="section2" style="width: 50%;margin-top: 0;">
            <div class="Cards" style="width: 100%;">
                ...
                <div class="card-detail" style="height: 42.5em; overflow: auto;">
