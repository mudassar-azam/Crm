...
<form class="FollowUpClientForm" action="{{route('client.follow.store')}}" method="post">
    @csrf
            ...
            <div class="data-wrapper" style="padding-bottom: 0; align-items: start; border-bottom: none !important;">
                <div class="data" style="width: 50% !important; padding-right: 0.2em;">
                    ...
                    <select name="status">
                        ...
                        <option value="chase 3">Chase 3</option>
                    </select>
                ...
                <div class="data" style="width: 50% !important; padding-left: 0.2em;">
                    ...
                    <input type="text" id="sport_areas" name="sport_areas">
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.getElementById('resetButton').addEventListener('click', function() {
        document.querySelector('.myFollowUpClientForm').reset();
    });
</script>
