    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function fetchStudentsAndLeaves() {
                fetch('{{ route('rooster.calendar.view.users') }}', {
                        method: 'GET',
                        headers: {
            ...
            function fetchLeavesAndGenerateTable() {
                const url =
                    `/allRoosters?month=${currentAttendanceMonth + 1}&year=${currentAttendanceYear}`; 
