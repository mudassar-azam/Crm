    ...
    <div class="right-side-header">
        ...
        <div class="login-profile">
            ...
            <div class="profile-detail">
                <span>
                    <b><a href="{{route('engineer.settings')}}">Settings</a></b>
...
@php 
    ...
    use App\Models\User;
    $user = Auth::user();
    $resource = Resource::where('email', $user->email)->first();
    $notifications = EngineerNotification::where('engineer_id', $resource->id)->get();       
@endphp 
