...
<div class="container1">
    <div class="box1">
                                ...
                                <div class="pair2">
                                    <div class="pair2-card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-name">
                                                <h4 style="cursor:pointer" id="approved-activities">Approved Activities
                                                </h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pair2-card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-name">
                                                <h4 style="cursor:pointer" id="confirmed-activities">Confirmed Activies
                                                </h4>
                                            </div>
                                        </div>
        ...
        <div class="section1" style="padding: 0.5em;">
            <div class="section2" style="width: 100%;">
                <div class="Cards" style="width: 100%;">
                    ...
                    <div class="card-detail" style="height: 19.5em; overflow: auto;">
                            ...
                            <div class="profile">
                                <a style="color: black !important;"
                                    ...
                                    <img style="height: 40px;width: 40px;"
                                        src="{{ asset('Asserts/General/user.png') }}">
                                </a>
                                <div class="name">
                                    <a style="color: black !important;"
                                        href="{{route('allAttendance' , $attendance->user->id )}}">
...
<div class="container2" style="width:100%;flex-direction: row;">
    <div class="section1" style="width: 50%;">
        ...
        if ($monthIndex >= 0 && $monthIndex < 12) { $monthlyActivities[$monthIndex]++; } } @endphp </div>
            <div class="section2" style="width: 49%;margin-top: 0;">
                <div class="Cards" style="width: 100%;">
                    <div class="Cards-header">
                        <div class="name">
                            <h3>Company Sales</h3>
                    ...
                    <div style="justify-content: center !important;" class="chart">
                        <canvas id="myPieChart" style="min-height: 31.5em !important;"></canvas>
