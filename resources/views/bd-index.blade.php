...
<div class="container1">
    ...
    <div class="container2" style="flex-direction: column; width: 54%;margin-top:0;">
        <div class="section2" style="margin-top:0; gap:1em;">
            <div class="Cards" style="width: 100%;">
                ...
                <div class="card-detail" style="height: 20em; overflow: auto;">
            ...
            <div class="Cards" style="width: 100%;">
                ...
                <div class="card-detail" style="height: 20em; overflow: auto;">
                    ...
                    @else
                    <div class="chart-data2">
                        <h5>No Attendance Recorded Yet</h5>
                    </div>
                    @endif
                </div>
            </div>
