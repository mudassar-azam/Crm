...
<form id="myformupdate" method="post" action="{{ route('totalactivity.update', ['id' => $activity->id]) }}"
        ...
        <div class="planned">
            ...
            <div class="data">
                ...
                <select name="activity_status" id="activity_status">
                    <option selected disabled>{{$activity->activity_status}}</option>
...
<script>
    ...
    function updateResource() {
        ...
        // Make Axios request
        axios.post('{{ route("totalactivity.update", ["id" => $activity->id]) }}', formData, {
                headers: {
